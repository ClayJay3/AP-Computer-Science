...
public class Quiz
{
	...
	public void giveQuiz(int minComplexity, int maxComplexity)
	{
		...
		for (Question question : questions)
		{
			if (question.getComplexity() >= minComplexity && question.getComplexity() <= maxComplexity)
			{
				System.out.println(question.getQuestion());
				question.setResponse(userInput.nextLine());
			}
	...
	public void add(String question, String answer, int complexity)
	{
		...
		{
			questions.add(new Question(question, answer, complexity));
		}
	}
